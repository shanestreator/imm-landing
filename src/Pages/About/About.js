      ...
      <div className="mt-5 pt-5">
        <div className="card red-card-shadow my-4">
          <div className="card-body text-center">
            ...
            <p className="card-text">
              ...
              during tough, uncertain times and good times as well. And you know
              what?
            </p>
          </div>
        </div>
        ...
        <div className="card red-card-shadow my-5">
          <div className="card-body text-center ">
            ...
            <p className="card-text">
              ...
              fights in Boxing, Kickboxing, Thai Boxing, Savate, San Shou, Bare
              Knuckle Karate, Brazilian Jui Jitsu and Extreme Fighting, and won
              numerous state, regional and U.S. titles.
            </p>
        ...
        <div className="card red-card-shadow my-5">
          <div className="card-body text-center ">
            ...
            <p className="card-text">
              I went from a construction laborer (an important, demanding job I
              was proud of, but I wanted more) to a supervisor in manufacturing,
              to a manager in asset recovery. I built highly motivated,
              disciplined, loyal and profitable teams in each of these
              industries. My latest step was starting my own online business
        ...
        <div className="card red-card-shadow my-5">
          <div className="card-body text-center ">
            ...
            <p className="card-text">
              ...
              positive relationship with an amazing woman who I married and have
              had only happiness with from the beginning.
            </p>
            <div className="container card-text carousel-width d-flex justify-content-center w-100">
              <Carousel
                className="carousel-width w-100"
        ...
        <div className="card red-card-shadow my-4">
          <div className="card-body text-center">
            <p className="card-text">
              ...
              motivation, inspiration, discipline, leadership, determination and
              more, that are in the Impact Motivation Manual.
            </p>
            <p className="card-text">
              In doing this, I created a mindset change in myself, that enabled
              my accomplishments in sports, work/business and relationships.
            </p>
            <p className="card-text">
              Now I want to share this powerful tool with everyone and anyone
              who is looking for a positive change in their life or simply want
              to optimize what they're already doing.
            </p>
          </div>
        </div>
