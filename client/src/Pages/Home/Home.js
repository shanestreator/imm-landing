        ...
        <div className="container-md px-md-4">
          ...
          <div className="text-center mt-5 pt-3">
            ...
            <p className="mt-5">
              ...
              promotes can dynamically optimize virtually any area of life. They
              can learn to overcome hindering, negative thoughts and develop or
              strengthen powerful, positive characteristics such as:
            </p>
            ...
            <div className="container px-md-5 d-flex justify-content-center">
              <div className="row d-flex justify-content-center">
                <div className="col-12 d-flex justify-content-center">
                  <img
                    src="/images/THINKER-MAN.gif"
                    alt="thinking-man"
                    className="img-fluid home__gif-size"
                  />
                </div>
              </div>
            </div>
            ...
            <Link
              ...
              type="button"
            >
              <button className="btn home__button-red-bg btn-lg">
                <h4 className="mb-0">
                  About
                  <i class="fas fa-arrow-right pl-2" />
                </h4>
              </button>
            </Link>
          </div>
